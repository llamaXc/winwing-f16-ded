	...
	if g_winwingInit==nil then
		...
		do
			...
			LuaExportStart=function()
				...
				Coroutines[CoroutineIndex] = coroutine.create(
					function()
						local tNext = t
						...
						do
							...
							--_winwing.LuaExportActivityNextEvent(tNext)
							tNext = coroutine.yield()
						end
					end
				)
				LoCreateCoroutineActivity(CoroutineIndex, _winwing.delay, _winwing.interval)
			end
